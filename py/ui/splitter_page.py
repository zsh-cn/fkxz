...
from utils.helpers import format_size, setup_context_menu, RoundedButton, RoundedProgressBar
from core.splitter import FileSplitter


class SplitterPage(ttk.Frame):
    ...
    def _build(self):
        ...
        tk.Label(
            header,
            text='将大文件拆分为多个分片，生成 .fk 分片文件和 .wjx 信息文件',
