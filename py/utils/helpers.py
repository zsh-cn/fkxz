...
class RoundedProgressBar(tk.Canvas):
    ...
    def _draw(self):
        ...
        self._draw_rounded_rect(0, 0, w, h, r, fill=self._track_color, outline='')
        ...
        if self._maximum > 0 and self._value > 0:
            ...
            if fill_w <= r * 2:
                ...
                self._draw_rounded_rect(0, 0, fill_w, h, r, fill=self._fill_color, outline='')
...
class RoundedButton(tk.Canvas):
    ...
    def _draw(self, bg=None):
        ...
        w = self._btn_width
        h = self._btn_height
        self._draw_rounded_rect(0, 0, w, h, r, fill=bg)
